package Question6;//Huffman Encoding-->Huffman encoding is a data compression algorithm used to compress text or binary
//        data by reducing the number of bits required to represent the data.
//Huffman Decoding-->Huffman decoding is the process of converting a stream of Huffman-encoded bits
// back into the original data symbols.
// The decoding process requires the same Huffman tree used to encode the data,
// which is typically transmitted along with the encoded data
